...
public class MC_Genero {
    ...
    public boolean nuevoGenero(Genero genero) {
        ...
        try {
            ...
            estado = false;
            emt.rollback();
            JOptionPane.showMessageDialog(null, "Error Al guardar El Genero" + e.getMessage(), "Error", 0, null);
    ...
    public boolean editarGenero(Genero genero) {
        ...
        try {
            ...
            estado = false;
            emt.rollback();
            JOptionPane.showMessageDialog(null, "Error Al Editar El Genero" + e.getMessage(), "Error", 0, null);
    ...
    public Genero buscarGenero(int idGenero) {
        ...
        try {
            ...
            emt.rollback();
            JOptionPane.showMessageDialog(null, "Error Al Buscar El Genero" + e.getMessage(), "Error", 0, null);
