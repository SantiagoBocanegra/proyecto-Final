...
CREATE INDEX PERMISO_has_USUARIO_FKIndex2 ON ROL_USUARIO (USUARIO_id);
CREATE INDEX ROL_USUARIO_FKIndex2 ON ROL_USUARIO (PERMISO_id);


CREATE INDEX IFK_Rel_13 ON ROL_USUARIO (USUARIO_id);
CREATE INDEX IFK_Rel_14 ON ROL_USUARIO (PERMISO_id);
